<template>
  <div>
    ...
    <div class="container margin_30">
      <div class="row"> 
        <div v-for="(item, index) in promotions" :key="index" v-if="showMore > index" class="col-md-6 col-lg-4 promo_container">
          ...
          <div class="promo_content">
            ...
            <nuxt-link class="read_more" :to="{ name: 'promotions-slug', params: { slug: item.slug }}">
  ...
  export default {
    ...
    computed: {
      ...
      promotions() {
        ...
        var temp_promo = [];
        _.forEach(promotions, function(value, key) {
