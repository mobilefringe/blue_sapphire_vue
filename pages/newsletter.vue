      ...
      <div class="row"> 
        ...
        <div class="col-lg-6">
          <div id="mc_embed_signup">
            <form action="https://cambridge-centre.us1.list-manage.com/subscribe/post?u=b26db4847968e3b7266c1945d&amp;id=6c8b980642" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank" novalidate>
              <div id="mc_embed_signup_scroll">
                ...
                <div class="mc-field-group input-group">
                    ...
                    <ul>
                      <li>
                        <input type="radio" value="I agree to receive Commercial Electronic Messages from Morguard, the management company of Cambridge Centre and its affiliates that will include: special retail sales offers, promotions, new retailer announcements, upcoming events, trend and style news and other inside information. You can unsubscribe at any time by emailing info@cambridge-centre.com. Morguard’s contact information is as follows: 55 City Centre Drive, Suite 800, Mississauga, ON, L5B 1M3, Attention: Privacy Officer. Website: morguard.com" name="OPTIN" id="mce-OPTIN-0"><label for="mce-OPTIN-0">I agree to receive Commercial Electronic Messages from Morguard, the management company of Cambridge Centre and its affiliates that will include: special retail sales offers, promotions, new retailer announcements, upcoming events, trend and style news and other inside information. You can unsubscribe at any time by emailing info@cambridge-centre.com. Morguard’s contact information is as follows: 55 City Centre Drive, Suite 800, Mississauga, ON, L5B 1M3, Attention: Privacy Officer. Website: morguard.com</label>
                      </li>
                    </ul>
                </div>
